    ...
    return (
      <div className="page-background">
        <Grid container centered stackable columns={3}>
          ...
          <Grid.Column textAlign='center'>
            <Icon name="file alternative" size="huge" inverted />
          ...
          <Grid.Column textAlign='center'>
            <Icon name="calender check" size="huge" inverted />
            <Header as="h1" inverted> Timestamped Notes </Header>
            <Header as="h3" inverted> TEach time you make contact with a contact, you can write a note that summarizes the conversation. This note is saved along with a timestamp with the contact.</Header>
          </Grid.Column>
